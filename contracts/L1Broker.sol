...
contract L1Broker {
    using SafeERC20 for IL2WithdrawableERC721;
    ...
    /// @param id The amount to mint in the decimal scale of the underlying ERC20.
    ...
    function mintL1NFT(
        ...
        // Mint the subtoken.
        token.mint(id, recipient, l1ERC721, l1ERC721, l1Bank);
  ...
  /** 
    function redeemIOU(uint256 id, uint256 amount) external {
        ...
        IL2WithdrawableERC721(l1ERC20).safeTransferFrom(
            l1Bank,
            msg.sender,
            amount
        );
